...
<script type="text/javascript">
	...
	function submit_data() {
		post_submit("query_data", "my_pwd_do.jsp", "_self");
	}
</script>
</head>
<%
	...
	String req_select = "user_pwd1,user_pwd2,user_pwd3";
	String req_view = "输入旧密码,输入新密码,确认新密码";
	String[] selects = req_select.split(",");
	String[] views = req_view.split(",");

	String menu_name = "修改密码";
			...
			<table width="100%" class="table table-hover">
				...
				<%
					for (int j = 0; j < selects.length; j++) {
						...
						out.println("<td align='left'><input type='password' name='" + selects[j].trim() + "' value='' size='50'/></td>");
						out.println("</tr>");
					}
				%>
			</table>
