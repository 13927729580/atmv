...
<script type="text/javascript">
	...
	function view_data() {
		post_submit("query_data", "tc_step.jsp", "_self");
	}
</script>
</head>
<%
	...
	String script = ProjectCase.gen_scripts(tc_id);
			...
			<table width="100%" align="left">
				<tr valign="middle">
					...
					<td align="right" style="border-bottom: solid 1px #cccccc;">
						<button class="btn btn-xs btn-default btn-me" id="view_data">视图模式</button>
