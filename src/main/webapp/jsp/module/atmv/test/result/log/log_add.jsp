...
<script type="text/javascript">
	...
	function submit_data() {
		post_submit("query_data", "log_add_do.jsp", "_self");
	}
</script>
</head>
<%
				...
				<%
					for (int j = 0; j < selects.length; j++) {
						...
						if (selects[j].trim().equals("work_group")) {
							...
							String work_groupv = HandleUser.get_user_value("user_id", loginuser_id, "work_group");
