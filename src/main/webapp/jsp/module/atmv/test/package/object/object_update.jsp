...
<script type="text/javascript">
	...
	function submit_data() {
		post_submit("query_data", "object_update_do.jsp", "_self");
	}
</script>
</head>
<%
	...
	String object_id = HandleRequest.get_string("object_id");
	String req_sql = "select a.* from t_funtest_object a where 1=1 and a.object_id='" + object_id + "'";
