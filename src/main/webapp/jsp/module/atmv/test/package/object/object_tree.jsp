...
<body>
	<div id="divlist" class="jstree" style="position: absolute; left; top: 1px; left: 0.1%; width: 15%; height: 99%; overflow: hidden; border: 1px solid #999999;">
		<ul>
			<%
				out.println("<li type='menu' data-jstree='{\"opened\":true}'>接口组件<ul>");
				for (int i = 0; i < dtm_01.getRowCount(); i++) {
					...
					for (int j = 0; j < dtm_02.getRowCount(); j++) {
						...
						out.println("<li type='node' data-jstree='{\"icon\":\"jstree-file\"}' ref='" + HandleRequest.get_path() + "/jsp/module/atmv/test/package/object/object_list.jsp?fun_code=" + fun_codev
								+ "'>" + fun_namev + "</li>");
					}
					out.println("</ul></li>");
				}
