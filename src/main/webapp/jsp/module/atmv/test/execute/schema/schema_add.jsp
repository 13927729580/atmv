...
<script type="text/javascript">
	...
	function submit_data() {
		post_submit("query_data", "schema_add_do.jsp", "_self");
	}
</script>
</head>
<%
				...
				<%
					for (int j = 0; j < selects.length; j++) {
						...
						if (selects[j].trim().equals("tc_status")) {
							out.println("<td align='left'>");
							out.println("<div><input type='text' name='" + selects[j].trim() + "' value='auto' size='50'/></div>");
							out.println("</td>");
							continue;
						}
						if (selects[j].trim().equals("tc_plugin")) {
							out.println("<td align='left'>");
							out.println("<div><input type='text' name='" + selects[j].trim() + "' value='java.code' size='50'/></div>");
							out.println("</td>");
							continue;
						}
